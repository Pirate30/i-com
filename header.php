...
$get_res = mysqli_query($con, 'select * from categories where status = 1');
$data_arr = array();
                                ...
                                <div class="header__right">
                                    ...
                                    <div class="header__account">
                                        ...
                                        if (isset($_SESSION['USER_LOGIN'])) {
                                            echo " <a href='logout.php'><i class='icon-logout icons'></i></a>";
                                        } else {
                                    ...
                                    <div class="htc__shopping__cart">
                                        ...
                                        <a href="cart.php"><span class="htc__qua"><?php echo $count ?></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
