    ...
    <div class="orders">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="box-title" style="font-size: 25px;">Orders Management </h4>
                    </div>
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="product-add-to-cart"><span class="badge badge-complete bg-primary"><a style="color: white;" href="order_manager_details.php?id= <?php echo $row['id'] ?>"> <?php echo $row['id'] ?></a></span></td>
